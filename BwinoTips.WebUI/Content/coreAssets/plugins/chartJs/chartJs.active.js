    ...
    var config = {
        ...
        data: {
            ...
            datasets: [{
                    type: 'line',
                    label: "Salles",
                    borderColor: "rgb(52, 224, 64)",
                    fill: false,
                    data: temp_dataset
                }, {
                    type: 'bar',
                    label: "Affiliate",
                    backgroundColor: "rgba(52, 224, 64, .1)",
                    borderColor: "rgba(52, 224, 64, .4)",
                    data: rain_dataset
                }]
        },
        options: {
            ...
            datasets: [
                {
                    ...
                    borderColor: "rgba(52, 224, 64, 0.7)",
                    borderWidth: "1",
                    backgroundColor: "rgba(52, 224, 64, 0.4)"
                },
                {
        ...
        data: {
            ...
            datasets: [
                ...
                },
                {
                    ...
                    borderColor: "#34E040",
                    borderWidth: "2",
                    backgroundColor: "rgba(52, 224, 64, 0.1)",
